...
- Include proper citations wherever citations are needed, and list all cited sources in a References section at the end of the document.
- The document must compile with pdflatex without external dependencies
